...
(function(){
  var mongohq, mongolab, mongosoup, mongourl, ismongo, request, express, querystring, mongo, Grid, MongoClient, speechsynthdir, path, fs, app, allowedLanguages, createDirectories, speechsynthFs, speechsynthMongo;
